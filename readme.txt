...
Este proyecto entrega números de la secuencia Fibonacci como fue pedido, además contiene un endpoint
...
era demasiado grande para los números mas altos de la secuencia, esto además se hizo para que la API no tuviera
...
protegidos ya que considerando que es un proyecto demostrativo no lo vi necesario, además permite que interactuen con
la base si lo desean)

Dejo aquí los CURLs de la aplicación en el entorno subido a Railway:

curl --location 'http://fibonacci-production-d155.up.railway.app/fibonacci/top-consulted/3'

curl --location 'http://fibonacci-production-d155.up.railway.app/fibonacci/6'